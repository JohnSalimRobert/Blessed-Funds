...
export const FormField = ({ field, register, error }: InputFieldProps) => (
  <div className="space-y-2">
    <Label htmlFor={field.name} className="text-slate-200">{field.label}</Label>
    <Input
      name={field.name}
      type={field.type}
      ...
      className="bg-slate-50 opacity-90 border border-zinc-300 focus-visible:border-indigo-500 transition-all duration-200 ease-in-out
